export default {
  ...
  route: {
    ...
    alarmMonitoring: "Real-time Monitoring",
    alarmNotifications: "Notifications",
    alarmAnalytics: "Analytics & Reports",
  },
  // Notice management internationalizatiodeviceNamePlaceholdern
  notice: {
  ...
  device: {
    ...
    protocolTypeCustomMqtt: "Custom MQTT",
    serialNumber: "Serial Number",
    department: "Department",
    location: "Location",
    createTime: "Create Time",
    ...
    deviceForm: {
      ...
      protocolType: "Protocol Type",
      protocolTypePlaceholder: "Select protocol type",
      serialNumber: "Serial Number",
      description: "Description",
      status: "Status",
      department: "Department",
      ...
      statusPlaceholder: "Select device status",
      locationPlaceholder: "Enter installation location",
      latitudePlaceholder: "Enter latitude",
      longitudePlaceholder: "Enter longitude",
      installDatePlaceholder: "Select install date",
      purchasePricePlaceholder: "Enter purchase price",
      warrantyExpiryPlaceholder: "Select warranty expiry",
      firmwareVersionPlaceholder: "Enter firmware version",
      hardwareVersionPlaceholder: "Enter hardware version",
      manufacturerPlaceholder: "Enter manufacturer",
      emqxUsernamePlaceholder: "Enter EMQX username",
      emqxPasswordPlaceholder: "Enter EMQX password",
      mqttClientIdPlaceholder: "Enter MQTT client ID",
      communityIdPlaceholder: "Enter community ID",
      edgeNodeIdPlaceholder: "Enter edge node ID (optional)",
      modbusHostPlaceholder: "Enter Modbus host IP",
      modbusPortPlaceholder: "Enter Modbus port",
      slaveIdPlaceholder: "Enter slave ID",
      pollingIntervalPlaceholder: "Enter polling interval",
      registerAddressPlaceholder: "Enter register address",
      registerTypePlaceholder: "Select register type",
      dataTypePlaceholder: "Select data type",
      apiKeyPlaceholder: "Enter API key",
      apiSecretPlaceholder: "Enter API secret (optional)",
      endpointPlaceholder: "Enter API endpoint",
      httpMethodPlaceholder: "Select HTTP method",
      authTypePlaceholder: "Select auth type",
      telemetryTopicPlaceholder: "Enter telemetry topic",
      commandTopicPlaceholder: "Enter command topic",
      qosPlaceholder: "Select QoS level",
      retainPlaceholder: "Select retain option",
      dataFormatPlaceholder: "Select data format",
      retain: "Retain",
      qos: "QoS",
      commandTopic: "Command Topic",
      telemetryTopic: "Telemetry Topic",
      customMqttConfig: "Custom MQTT Configuration",
      sparkplugBConfig: "Sparkplug B Configuration",
      ...
      httpConfig: "HTTP JSON Configuration",
    },
    ...
    emqx: {
      ...
      deviceId: "Device ID",
      mqttClientIdLabel: "MQTT Client ID",
      emqxUsernameLabel: "EMQX Username",
      emqxPasswordLabel: "EMQX Password",
      telemetryTopicLabel: "Telemetry Topic",
      commandTopicLabel: "Command Topic",
    ...
    // Device Details
    detail: {
      configTitle: "Device Configuration Details",
      locationInfo: "Location Information",
      modalTitle: "Device Details",
      unknownError: "Unknown error",
      getDetailError: "Failed to get device details",
    },
  ...
  // Alarm Module Internationalization
  alarm: {
    // Common
    title: "Alarm Management",
    dashboardTitle: "Alarm Dashboard",
    ...
    dashboard: {
      ...
      highAlarms: "High Priority Alarms",
      mediumAlarms: "Medium Alarms",
      ...
      viewAll: "View All",
      noRecentAlarms: "No recent alarms",
      topDevices: "Top Devices by Alarms",
      alarms: "Alarms",
      noDeviceData: "No device data available",
      justNow: "Just now",
      minutesAgo: "{minutes} minutes ago",
      hoursAgo: "{hours} hours ago",
      totalActive: "Total Active Alarms",
      critical: "Critical Alarms",
      high: "High Priority",
      medium: "Medium Priority",
      low: "Low Priority",
      unacknowledged: "Unacknowledged",
      acknowledgedRate: "Acknowledged Rate",
      resolutionTime: "Avg Resolution Time",
      trendChart: "Alarm Trends",
      deviceAlarms: "Device Alarms",
      noData: "No alarm data available",
    ...
    monitoring: {
      ...
      severityFilter: "Select Severity",
      statusFilter: "Select Status",
      deviceFilter: "Select Device",
      totalAlarms: "Total Alarms",
      criticalAlarms: "Critical Alarms",
      highAlarms: "High Priority Alarms",
      unacknowledged: "Unacknowledged Alarms",
      severity: "Severity",
      ruleName: "Rule Name",
      message: "Message",
      threshold: "Threshold",
      ...
      comment: "Comment",
      confirmAcknowledge: "Are you sure you want to acknowledge this alarm?",
      confirmResolve: "Are you sure you want to resolve this alarm?",
      confirmBulkAcknowledge: "Are you sure you want to acknowledge {count} alarms?",
      confirmBulkResolve: "Are you sure you want to resolve {count} alarms?",
      acknowledgeSuccess: "Alarm acknowledged successfully",
      resolveSuccess: "Alarm resolved successfully",
      bulkAcknowledgeSuccess: "{count} alarms acknowledged successfully",
      bulkResolveSuccess: "{count} alarms resolved successfully",
      operationFailed: "Operation failed",
      noAlarmsSelected: "No alarms selected",
    ...
    notifications: {
      ...
      description: "Manage alarm notification channels and recipient settings",
      ...
      emailAddressesPlaceholder: "Enter email addresses, separated by commas",
      emailAddressesRequired: "Please enter email addresses",
      emailSubject: "Email Subject",
      emailSubjectPlaceholder: "Alarm Notification: {alarmName}",
      phoneNumbers: "Phone Numbers",
      phoneNumbersPlaceholder: "Enter phone numbers, separated by commas",
      phoneNumbersRequired: "Please enter phone numbers",
      webhookUrl: "Webhook URL",
      webhookUrlPlaceholder: "https://example.com/webhook",
      webhookUrlRequired: "Please enter webhook URL",
      httpMethod: "HTTP Method",
      headers: "Request Headers",
      headersPlaceholder: "Enter request headers in JSON format",
      slackWebhookUrl: "Slack Webhook URL",
      slackWebhookUrlPlaceholder: "https://hooks.slack.com/services/...",
      slackWebhookUrlRequired: "Please enter Slack webhook URL",
      slackChannel: "Slack Channel",
      slackChannelPlaceholder: "#general",
      slackChannelRequired: "Please enter Slack channel",
      ...
      testSuccess: "Channel test successful",
      ...
      toggleSuccess: "Channel status updated successfully",
      ...
      notificationPreferences: {
        ...
        confirmReset: "Reset all preferences to default settings?",
      },
    ...
    analytics: {
      ...
      metrics: {
        ...
        topDevices: "Top Devices by Alarms",
        topMetrics: "Top Metrics by Alarms",
      ...
      // Charts
      charts: {
        alarmVolume: "Alarm Volume Over Time",
        resolutionTime: "Resolution Time Trends",
        severityDistribution: "Severity Distribution",
    ...
    sound: {
      ...
      enabled: "Sound Notifications Enabled",
      disabled: "Sound Notifications Disabled",
      volume: "Volume",
      testSound: "Test Sound",
      severitySettings: "Severity-based Sounds",
      customSounds: "Custom Sound Settings",
    },
    ...
    // Error Messages
    errors: {
      loadFailed: "Failed to load alarm data",
      saveFailed: "Failed to save changes",
      deleteFailed: "Failed to delete alarm",
      acknowledgeError: "Failed to acknowledge alarm",
      acknowledgeFailed: "Failed to acknowledge alarm",
      resolveError: "Failed to resolve alarm",
    ...
    success: {
      ...
      acknowledged: "Alarm acknowledged successfully",
    },
    ...
    validation: {
      ...
      commentTooLong: "Comment is too long (max 500 characters)",
    },
